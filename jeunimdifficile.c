...
int main(int argc, char *argv[]) {
  int matches = 16; // Nombre d'allumettes
  ...
  while (matches > 0) // Tant que le nombre d'allumette est superieur à 0
  {
    ...
    if (matches ==
      ...
      if (matches ==
        ...
        if (nb_matches_out_player == 1) { //si le joueur met 1 allumette alors
          nb_matches_out_AI = 3; // L'IA en met 3
        } else if (nb_matches_out_player == 2) {  //si le joueur met 2 allumettes alors
          nb_matches_out_AI = 2; // L'IA en met 2
        } else if (nb_matches_out_player == 3) {  //si le joueur met 3 allumettes alors
          nb_matches_out_AI = 1; // L'IA en met 1
        }
        matches -=
